...
import { checkedExec, defaultDaytonaExec } from "@offlinegpt/hosts";
import type { ChildProcess } from "node:child_process";
import type { DenRef } from "@offlinegpt/behaviors";
import type { DaytonaExec } from "@offlinegpt/hosts";

const DAYTONA_LINK_SCRIPT = "/tmp/offlinegpt-den-link-server.mjs";
const DAYTONA_LINK_PID = "/tmp/offlinegpt-den-link-server.pid";
