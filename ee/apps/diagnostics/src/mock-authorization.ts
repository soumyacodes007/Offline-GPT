...
const redisKeyPrefix = "offlinegpt:diagnostics:mock-authorization:v1"
const subjectPattern = /^[a-f0-9]{64}$/u

declare global {
  var __offlinegptDiagnosticsMockAuthorizations: Map<string, number> | undefined
}

const localAuthorizations = globalThis.__offlinegptDiagnosticsMockAuthorizations ??= new Map()
