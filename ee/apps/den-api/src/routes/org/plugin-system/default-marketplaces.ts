...
export const DEFAULT_OFFLINEGPT_MARKETPLACE_NAME = "OfflineGPT Marketplace"
export const DEFAULT_OFFLINEGPT_MARKETPLACE_DESCRIPTION = "Built-in OfflineGPT AI capabilities available in the desktop app after sign-in."
export const DEFAULT_OFFLINEGPT_MARKETPLACE_LOGO_URL = "/offlinegpt-mark.svg"
