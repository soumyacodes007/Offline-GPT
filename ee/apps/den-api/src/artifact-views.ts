import { and, desc, eq, isNull, isNotNull } from "@offlinegpt-ee/den-db/drizzle"
import { ArtifactViewRevisionTable, ArtifactViewTable, DashboardAppTable } from "@offlinegpt-ee/den-db/schema"
import { createDenTypeId, normalizeDenTypeId, type DenTypeId } from "@offlinegpt-ee/utils/typeid"
import type { GeneratedArtifactView, GeneratedArtifactViewRevision } from "@offlinegpt/types/workflows"
