import { and, asc, count, eq, gt, inArray, isNotNull, isNull, sql } from "@offlinegpt-ee/den-db/drizzle"
import {
  AuthSessionTable,
  AuthUserTable,
...
export async function getInvitationPreview(invitationIdRaw: string): Promise<InvitationPreview | null> {
  ...
  return {
    ...
    organization: {
      ...
      branding: {
        appName: typeof organizationMetadata.brandAppName === "string" ? organizationMetadata.brandAppName : "OfflineGPT",
