...
test.each([
  ["mac-arm64", "v9.9.9", "offlinegpt-mac-arm64-9.9.9.dmg"],
  ["mac-x64", "9.9.9", "offlinegpt-mac-x64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "offlinegpt-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "offlinegpt-linux-x86_64-9.9.9.AppImage"],
  ["linux-arm64", "v9.9.9", "offlinegpt-linux-arm64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "offlinegpt-enterprise-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "offlinegpt-enterprise-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "offlinegpt-enterprise-linux-x86_64-9.9.9.AppImage"],
...
test.each([
  ["mac-arm64", "v9.9.9", "offlinegpt-cloud-mac-arm64-9.9.9.dmg"],
  ["win-x64", "v9.9.9", "offlinegpt-cloud-win-x64-9.9.9.exe"],
  ["linux-x64", "v9.9.9", "offlinegpt-cloud-linux-x86_64-9.9.9.AppImage"],
...
test("resolves only a mounted installer asset and reports its size", async () => {
  ...
  const fileName = "offlinegpt-enterprise-win-x64-9.9.9.exe"
  ...
  await expect(resolveConfiguredInstallerArtifact("offlinegpt-cloud-win-x64-9.9.9.exe")).resolves.toBeNull()
...
test("ignores a directory with the expected filename", async () => {
  const artifactsDir = mkdtempSync(path.join(os.tmpdir(), "ow-installer-artifacts-"))
  const fileName = "offlinegpt-cloud-win-x64-9.9.9.exe"
