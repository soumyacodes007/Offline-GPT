...
function seedRequiredEnv() {
  process.env.DATABASE_URL = process.env.DATABASE_URL ?? "mysql://root:password@127.0.0.1:3306/offlinegpt_test_sso_provider_rotation"
...
const canonicalProviderIds = {
  first: `offlinegpt-sso-${firstOrganizationId}`,
  recovery: `offlinegpt-sso-${recoveryOrganizationId}`,
}
