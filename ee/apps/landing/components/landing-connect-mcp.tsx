...
import {
  ...
  OPENCODE_SNIPPET,
  VS_CODE_COMMAND,
} from "./offlinegpt-connect-installer-config";
import type { OfflineGPTConnectClientId } from "./offlinegpt-connect-installer-config";

const DOCS_URL = "https://offlinegptlabs.com/docs/cloud/run-in-the-cloud/cloud-mcp#connect-mcp-install-opencode";
const SIGNUP_URL = "https://app.offlinegptlabs.com?mode=sign-up";

type CopyMethod = "clipboard" | "execCommand" | "none";
type ClientId = OfflineGPTConnectClientId;
    ...
    <section id="connect-mcp" className="landing-shell rounded-[2.5rem] p-8 md:p-12 scroll-mt-24">
      <div className="mb-10">
        ...
        <h2 className="max-w-3xl text-3xl font-medium leading-[1.15] tracking-tight md:text-4xl lg:text-5xl">
          Already doing it in your agent?<br />Add it to OfflineGPT. Share it with everyone.
        </h2>
        <p className="mt-5 max-w-3xl text-[16px] leading-7 text-gray-600 md:text-lg md:leading-8">
          ...
          and your whole team runs them in OfflineGPT — or from their own agent.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch">
        ...
        >
          ...
          <div className="flex flex-1 flex-col gap-4 p-4 font-mono text-[12px] leading-6 text-gray-100 md:p-5">
            <div>
              <span className="text-cyan-300">❯</span> share my skills and MCPs with my OfflineGPT org
            </div>
      ...
      >
        ...
        <div className="min-w-0">
          <div
            role="tablist"
            aria-label="OfflineGPT MCP client install options"
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <p className="text-[12px] leading-5 text-gray-500">
                          Works with your OfflineGPT account —{" "}
                          <a
                            href={SIGNUP_URL}
                            target="_blank"
                            rel="noreferrer"
                        ...
                        <button
                          type="button"
                          aria-label="Copy the OfflineGPT MCP install command"
                          onClick={() => {
        ...
        <div className="mt-5 flex flex-col gap-2 border-t border-gray-100 pt-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
            ...
            <button
              type="button"
              aria-label="Copy the OfflineGPT MCP server URL"
              onClick={() => {
                void copyServerUrl();
              }}
      ...
      <div className="mt-8 flex flex-col gap-3 border-t border-gray-100 pt-5 text-[13px] leading-6 text-gray-600 sm:flex-row sm:items-center sm:justify-between">
        <p>
          ...
          support — your agent signs in with your OfflineGPT account, and access is scoped by org membership, roles, policies, and exposure allowlists.
        </p>
        <a
          href={DOCS_URL}
          target="_blank"
