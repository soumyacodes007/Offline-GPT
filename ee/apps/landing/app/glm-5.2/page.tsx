...
const CLOUD_SIGNUP_URL =
  "https://app.offlinegptlabs.com?mode=sign-up&intent=models";
const CALENDAR_URL =
...
const glmSchema = {
  ...
  name: "OfflineGPT — GLM 5.2",
  description:
    "GLM 5.2 is available through OfflineGPT Models with 2x usage. Run real agent work on an open model at a fraction of the cost.",
  url: "https://offlinegptlabs.com/glm-5.2",
...
export const metadata = {
  title: "GLM 5.2 is now in OfflineGPT — with 2x usage",
  description:
...
const features = [
  {
    title: "OfflineGPT Models — 2x usage",
    body: "GLM 5.2 is available through OfflineGPT Models, our managed way to access leading OSS models without bringing your own keys. We're doubling your usage so your team can run real agent work at a fraction of the cost.",
    color: "border-sky-100 bg-sky-50/60"
  },
  {
    title: "Run your day from chat",
    body: "Orchestrate OfflineGPT fully through chat. Tasks now organize into groups — In progress, Done, Requires attention — and you can move them by asking, not clicking. Try: \"Put this session in In progress now.\"",
  ...
  {
    title: "Voice mode",
    body: "Control the OfflineGPT UI by voice. Talk through a task, navigate panels, and drive the agent without touching the keyboard.",
    color: "border-amber-100 bg-amber-50/50"
  },
  {
    title: "Advanced analytics on OfflineGPT Cloud",
    body: "The cloud platform now has advanced analytics — usage, activity, and team behavior in one view. If you're running OfflineGPT across a team, this is your new dashboard.",
        ...
        <div className="content-max-width px-6">
          ...
          <div className="animate-fade-up max-w-3xl">
            ...
            <p className="mb-6 text-[17px] leading-relaxed text-gray-700">
              GLM 5.2 is available today through OfflineGPT Models, and we&apos;re
              doubling your usage so you and your team can run real agent work on
              an open model at a fraction of the cost. OfflineGPT Models is our
          ...
          <section className="landing-shell my-12 rounded-2xl p-8">
            ...
            <p className="mb-6 text-[15px] leading-relaxed text-gray-700">
              Open OfflineGPT, switch to GLM 5.2 from the model picker, and ask the
              chat to organize your tasks. No setup, no keys — OfflineGPT Models
              handles the rest.
            </p>
            <div className="flex flex-wrap items-center gap-3">
              <a
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="feature-card">
                ...
                <p className="text-[14px] text-gray-700">
                  Create a free OfflineGPT Cloud account. After signup, you land
                  directly on the OfflineGPT Models page.
                </p>
              </div>
              <div className="feature-card">
                ...
                <p className="text-[14px] text-gray-700">
                  Subscribe to OfflineGPT Models ($10/user/mo). GLM 5.2 is included
          ...
          <section className="my-12 flex flex-col items-center gap-4 rounded-2xl border border-gray-200 bg-white/60 p-8 text-center">
            ...
            <p className="max-w-xl text-[15px] text-gray-600">
              ...
              app. Start free, subscribe to OfflineGPT Models, and get 2x usage on
              GLM 5.2.
            </p>
