...
export const alt = "OfflineGPT Cloud";
export const size = {
  width: 1200,
  height: 630
};
          ...
          <div style={{ display: "flex", flexDirection: "column", width: 580, gap: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <div style={{ fontSize: 24, fontWeight: 600 }}>OfflineGPT Cloud</div>
              </div>
            </div>
            ...
            <div style={{ fontSize: 24, lineHeight: 1.45, color: "#475569", display: "flex", maxWidth: 520 }}>
              Share setups across your org, keep selected workflows available, and manage OfflineGPT Cloud from app.offlinegptlabs.com.
            </div>
