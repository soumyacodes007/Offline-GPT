export const MCP_AUTHORIZATION_WINDOW_CLOSED_MESSAGE =
  "The sign-in window closed before OfflineGPT confirmed the connection. Review the provider error, then try again.";

export const MCP_AUTHORIZATION_TIMEOUT_MESSAGE =
  "OfflineGPT could not confirm the connection. Review the provider error in this window, then try again.";

export const MCP_AUTHORIZATION_UNCONFIRMED_CONNECTED_MESSAGE =
  "The provider responded, but OfflineGPT could not confirm this account connection. Review the provider configuration, then try again.";
