      ...
      message={(
        <span className="grid gap-2">
          ...
          <span className="grid gap-1 text-[13px]">
            ...
            <span><strong className="font-semibold">Safari:</strong> Safari &gt; Settings &gt; Privacy &gt; Manage Website Data, remove offlinegptlabs.com, then reload.</span>
            <span><strong className="font-semibold">Firefox or another browser:</strong> Clear cookies and site data for offlinegptlabs.com in site settings, then press Cmd/Ctrl+Shift+R.</span>
          </span>
        </span>
      )}
    />
