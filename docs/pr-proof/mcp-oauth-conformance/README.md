...
OfflineGPT's local OAuth MCP conformance server; it does not use a third-party
...
1. URL-only requirements discovery reports OAuth, registration, scope, and
   ...
   client.
2. DCR identifies OfflineGPT as a web client, PKCE authorization completes, and
