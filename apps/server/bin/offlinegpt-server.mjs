...
const binaryName = process.platform === "win32" ? "offlinegpt-server.exe" : "offlinegpt-server";
...
console.error(
  `Unable to find an OfflineGPT server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
