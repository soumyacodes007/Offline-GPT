 ...
 */
const HEADER = "x-offlinegpt-title-attempt";
...
export const OfflineGPTTitleRecovery = async (input: {
  ...
  const emit = (diagnostic: Diagnostic) => {
    ...
    void input.client.app.log({ body: {
      service: "offlinegpt.title", level, message: "Automatic title generation", extra: diagnostic,
    } }).catch(() => undefined);
  };
  return {
