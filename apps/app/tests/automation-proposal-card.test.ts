...
import { parseAutomationProposal } from "../src/components/tools/offlinegpt-automation-proposal";
...
describe("Automation proposal card", () => {
  test("reads a proposal out of an offlinegpt_execute result, string or object", () => {
