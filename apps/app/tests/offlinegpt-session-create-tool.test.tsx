...
import { OfflineGPTSessionCreateTool } from "../src/components/tools/offlinegpt-session-create";
...
function sessionCreatePart(): DynamicToolUIPart {
  return {
    type: "dynamic-tool",
    toolName: "offlinegpt_session_create",
...
describe("OfflineGPTSessionCreateTool", () => {
    ...
    const html = renderToStaticMarkup(
      <MemoryRouter>
        <MessageListProvider
          ...
          onMcpRetry={noop}
        >
          <OfflineGPTSessionCreateTool part={sessionCreatePart()} />
        </MessageListProvider>
      </MemoryRouter>,
    );

    expect(html).toContain("data-offlinegpt-session-create-card");
