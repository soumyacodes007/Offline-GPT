...
export type OfflineGPTSessionCreateResult = {
  ok: boolean
...
export function parseOfflineGPTSessionCreateResult(output: unknown): OfflineGPTSessionCreateResult | null {
...
export function OfflineGPTSessionCreateTool({ part }: { part: DynamicToolUIPart }) {
  ...
  const result = parseOfflineGPTSessionCreateResult(part.output)
  if (!result) {
  ...
  return (
    <div
      ...
      data-offlinegpt-session-create-card
