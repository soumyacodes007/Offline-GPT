...
export function blueprintSessions(config: WorkspaceOfflineGptConfig | null | undefined): WorkspaceBlueprintSessionTemplate[] {
...
export function blueprintMaterializedSessions(config: WorkspaceOfflineGptConfig | null | undefined): WorkspaceBlueprintMaterializedSession[] {
...
export function normalizeWorkspaceOfflineGptConfig(
  value: unknown,
  preset?: string | null,
): WorkspaceOfflineGptConfig {
  const candidate =
    value && typeof value === "object"
      ? (value as Partial<WorkspaceOfflineGptConfig>)
      : {};
