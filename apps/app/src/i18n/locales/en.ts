 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, OfflineGPT) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "OfflineGPT server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "OfflineGPT server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "composer.connect_skill_prompt": "Use the \"{name}\" skill from the \"{marketplace}\" marketplace. Find it with offlinegpt-cloud_search_capabilities, then call offlinegpt-cloud_execute_capability with the exact capability name \"{capability}\", follow the returned skill content, and use it to ",
  ...
  "connect.connected_to_cloud": "Connected to OfflineGPT Cloud",
  "connect.connected_to_org": "Connected to {name}",
  "connect.diagnostics_action_label": "Recommended action",
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed OfflineGPT agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved OfflineGPT agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "OfflineGPT agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective OfflineGPT agent resolution",
  "connect.diagnostics_check_cloud_endpoint_differential": "Runtime probe vs engine verdict",
  "connect.diagnostics_check_cloud_endpoint_transport": "OfflineGPT Cloud endpoint transport",
  "connect.diagnostics_check_cloud_tool_catalog": "OfflineGPT Cloud tool catalog",
  ...
  "connect.diagnostics_global_cloud_mcp": "Global OfflineGPT Cloud MCP",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and OfflineGPT-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_org_description": "These connections operate behind the single OfflineGPT Cloud meta-MCP and are not injected as separate engine MCPs.",
  ...
  "connect.diagnostics_owner_offlinegpt_client": "OfflineGPT client",
  "connect.diagnostics_owner_offlinegpt_server": "OfflineGPT server",
  "connect.diagnostics_owner_offlinegpt_support": "OfflineGPT support",
  ...
  "connect.diagnostics_configured_agent": "Configured OfflineGPT agent",
  "connect.diagnostics_effective_agent": "Effective OfflineGPT agent",
  "connect.diagnostics_agent_state": "OfflineGPT agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote OfflineGPT workspace to run this report.",
  "connect.diagnostics_workspace_cloud_mcp": "Selected workspace OfflineGPT Cloud MCP",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from OfflineGPT Den.",
  ...
  "connect.pitch_title": "Connect is the new way OfflineGPT lets you share workflows with your team.",
  ...
  "connect.state_not_configured_action": "Sign in to OfflineGPT Cloud to finish setup.",
  ...
  "connect.state_unavailable_action": "Restart OfflineGPT. If this continues, run diagnostics.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected OfflineGPT servers.",
  ...
  "config.server_needed_hint": "OfflineGPT server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an OfflineGPT server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "OfflineGPT server",
  ...
  "config.server_sharing_title": "OfflineGPT server sharing",
  "config.server_url_hint": "Use the URL shared by your OfflineGPT server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "OfflineGPT server URL",
  "config.server_url_label": "OfflineGPT Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable OfflineGPT server workspace to edit authorized folders.",
  ...
  "context_panel.effective_permissions_unavailable": "Connect to an OfflineGPT server workspace with a running engine to see how agents run here.",
  ...
  "context_panel.permission_source_offlinegpt": "OfflineGPT",
  "context_panel.permission_source_workspace": "This workspace's opencode.json",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "OfflineGPT server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "OfflineGPT server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "OfflineGPT server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable OfflineGPT server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted OfflineGPT worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted OfflineGPT worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an OfflineGPT server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the OfflineGPT server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted OfflineGPT worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update OfflineGPT and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and OfflineGPT will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs OfflineGPT server",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access OfflineGPT Cloud.",
  "den.cloud_section_title": "OfflineGPT Cloud",
  "den.cloud_sleep_hint": "Sign in to OfflineGPT Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use OfflineGPT Cloud.",
  "den.open_dashboard": "Open Den dashboard",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "OfflineGPT Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but OfflineGPT Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid OfflineGPT sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete OfflineGPT Cloud sign-in.",
  ...
  "den.error_signout_failed": "Could not sign out of OfflineGPT Cloud. Try again.",
  ...
  "den.signin_code_note": "Accepts an offlinegpt://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into OfflineGPT automatically, paste the sign-in link or one-time code from OfflineGPT Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "offlinegpt://den-auth?... or pasted code",
  "den.signin_title": "Sign in to OfflineGPT Cloud",
  "den.signing_in": "Finishing OfflineGPT Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect OfflineGPT.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the OfflineGPT link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect OfflineGPT.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the OfflineGPT link, then paste it below.",
  "den.status_cloud_signed_in_as": "Connected OfflineGPT Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected OfflineGPT Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your OfflineGPT Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. OfflineGPT is using the default Cloud control plane.",
  ...
  "extensions.add_picker_hint": "Create something in OfflineGPT, add an MCP server by URL, or manage a hosted service connection in Den.",
  ...
  "extensions.kind_connection_hint": "Browse hosted services and manage setup for this organization in OfflineGPT Den.",
  ...
  "extensions.create_skill_hint": "Saved to your organization Library. Agents can load these instructions from OfflineGPT Cloud.",
  ...
  "extensions.add_sign_in_required": "Sign in to OfflineGPT Cloud to add items to Library.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the OfflineGPT app.",
  ...
  "extensions.add_unauthorized": "Your OfflineGPT Cloud session expired. Sign in again, then create the skill.",
  ...
  "extensions.empty_connections": "{org} has not shared any connections with you yet. An admin adds them in the OfflineGPT Cloud dashboard.",
  "extensions.empty_connections_signed_out": "Connections are shared by your organization. Sign in to OfflineGPT Cloud from Account to see yours.",
  ...
  "extensions.marketplace_description": "Browse OfflineGPT built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through OfflineGPT Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "extensions.surface_cloud": "OfflineGPT Cloud",
  ...
  "mcp.toggle_requires_server": "Connect to an OfflineGPT server to enable or disable MCPs.",
  "mcp.action_reconnect": "Reconnect",
  "mcp.add_modal_subtitle": "Connect a custom MCP to this workspace. This setup stays separate from organization-managed services in OfflineGPT Connect.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so OfflineGPT can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, OfflineGPT needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, OfflineGPT needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize OfflineGPT",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from OfflineGPT.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so OfflineGPT-managed sign-ins are paused.",
  "mcp.name_required": "Enter a server name.",
  "mcp.name_reserved_offlinegpt_connect": "This name is reserved for OfflineGPT Connect. Choose a different name for the workspace MCP.",
  "mcp.no_apps_hint": "Connect one above to get started.",
  "mcp.no_apps_yet": "No apps connected yet",
  "mcp.oauth": "Sign in",
  "mcp.oauth_advanced_hint": "This desktop handles sign-in and token refresh, and encrypts the OAuth credentials in this device's protected app storage. This is separate from OfflineGPT Connect and does not connect other devices.",
  ...
  "mcp.oauth_secret_warning": "OfflineGPT encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_offlinegpt_cloud_desc": "Manage your org, workers, skills, providers, and team config from chat. Try: \"List all workers in my org\" or \"Push this skill to the team.\"",
  "mcp.quick_connect_offlinegpt_cloud_title": "OfflineGPT Cloud Control",
  "mcp.quick_connect_offlinegpt_ui_desc": "Let agents see and drive the OfflineGPT app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_offlinegpt_ui_title": "OfflineGPT UI Control",
  ...
  "notifications.empty_hint": "Updates from OfflineGPT Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the OfflineGPT server",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. OfflineGPT will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// OfflineGPT server URL.",
  "welcome.organization_server_link": "Using OfflineGPT on-premises?",
  "welcome.organization_server_url_label": "Organization server URL",
  "welcome.organization_server_url_placeholder": "https://offlinegpt.yourcompany.com",
  "welcome.team_signin": "Joining a team? Sign in",
  "welcome.use_cloud": "Use OfflineGPT Cloud",
  "welcome.use_cloud_subtitle": "Sign in for hosted OfflineGPT and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. OfflineGPT will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and OfflineGPT can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. OfflineGPT will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like an OfflineGPT invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid OfflineGPT organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "OfflineGPT could not reach that organization server. Check your connection or VPN, then try again.",
  "join_org.input_hint": "Accepted: invite links, install links, server URLs, “server token”, offlinegpt://den-auth links, or a raw sign-in code.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. OfflineGPT now points at {host} and is ready when you come back.",
  "join_org.offlinegpt_cloud": "OfflineGPT Cloud",
  ...
  "session.share_local_host_not_ready": "Local OfflineGPT host is not ready yet.",
  "session.share_missing_host_url": "Missing OfflineGPT host URL.",
  "session.share_missing_token": "Missing OfflineGPT token.",
  ...
  "session.share_offlinegpt_workers_only": "Share service links are available for OfflineGPT workers.",
  ...
  "settings.privacy_section_desc": "Control what OfflineGPT shares to improve the product.",
  ...
  "settings.capabilities_title": "OfflineGPT server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point OfflineGPT at a local OpenCode build",
  ...
  "settings.debug_offlinegpt_server_version": "OfflineGPT server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "OfflineGPT writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No OfflineGPT-managed keys removed.",
  "settings.runtime_config_backup_path": "Backup: {path}",
  "settings.runtime_config_no_backup": "No backup needed.",
  "settings.error": "Error",
  "settings.idle": "Idle",
  "settings.loading": "Loading",
  "settings.deeplink_hint": "Accepts offlinegpt:// or offlinegpt-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which OfflineGPT events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by OfflineGPT. Off by default.",
  ...
  "settings.feedback_title": "Help shape OfflineGPT",
  ...
  "settings.nuke_confirmation_hint": "OfflineGPT will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local OfflineGPT, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed OfflineGPT app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's OfflineGPT state (.opencode/offlinegpt) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste an OfflineGPT deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard OfflineGPT Cloud.",
  "settings.organization_server_desc": "Point OfflineGPT at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's OfflineGPT server URL. Saving signs you out so OfflineGPT can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by OfflineGPT.",
  ...
  "settings.offlinegpt_config_sidecar_desc": "Local OfflineGPT server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.offlinegpt_diagnostics_title": "OfflineGPT server diagnostics",
  "settings.offlinegpt_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.offlinegpt_server_label": "OfflineGPT server",
  ...
  "settings.quit_hint": "OfflineGPT quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect OfflineGPT server.",
  "settings.reconnected": "Reconnected to OfflineGPT server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears OfflineGPT cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears OfflineGPT cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. OfflineGPT will restart.",
  ...
  "settings.reset_onboarding_description": "Clears OfflineGPT preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears OfflineGPT local preferences and workspace onboarding markers.",
  "settings.reset_offlinegpt_desc_dev": "With dev mode active, it only clears the isolated OpenCode dev state inside offlinegpt-dev-data.",
  "settings.reset_offlinegpt_desc_prod": "With dev mode active, it only clears the isolated OpenCode dev state inside offlinegpt-dev-data.",
  "settings.reset_offlinegpt_title": "Reset OfflineGPT + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but OfflineGPT will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_offlinegpt_server": "Restart OfflineGPT server",
  ...
  "settings.services_section_desc": "Local services that power this OfflineGPT session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting OfflineGPT.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs OfflineGPT will use after local overrides and bootstrap files are applied.",
  "settings.server_endpoints_local_dev": "Local dev server",
  "settings.server_endpoints_mismatch": "Doesn't match API endpoint",
  "settings.server_endpoints_not_configured": "No offlinegpt-cloud MCP entry configured",
  ...
  "settings.runtime_desc": "Status for your local engine and OfflineGPT server.",
  ...
  "settings.tab_connect": "OfflineGPT Connect",
  ...
  "settings.tab_description_appearance": "Adjust how OfflineGPT looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected OfflineGPT workspace plus its runtime connection.",
  ...
  "settings.environment.footer_hint": "OFFLINEGPT_ and OPENCODE_ keys are reserved for app/runtime wiring. Configure OpenCode runtime settings from your shell.",
  "settings.environment.override_hint": "Environment variables set before OfflineGPT starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "OfflineGPT will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "OfflineGPT is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but OfflineGPT status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OFFLINEGPT_ and OPENCODE_ names are managed by OfflineGPT/OpenCode.",
  ...
  "settings.update_blocked_org": "OfflineGPT {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  "settings.update_blocked_policy": "OfflineGPT {version} is available, but this installation is not eligible for it yet.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts OfflineGPT and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts OfflineGPT now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep OfflineGPT up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an OfflineGPT host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected OfflineGPT server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active OfflineGPT Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active OfflineGPT Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "OfflineGPT Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full OfflineGPT features",
  ...
  "status.offlinegpt_ready": "OfflineGPT Ready",
  ...
  "system.reload_body_default": "OfflineGPT detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "OfflineGPT detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "OfflineGPT can't load tasks from this worker until the connection is fixed.",
