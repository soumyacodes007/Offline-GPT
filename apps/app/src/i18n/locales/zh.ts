/**
 * 中文（简体）翻译
 * 产品名称保留英文：OpenCode、OpenPackage、OfflineGPT
...
export default {
  ...
  "app.plugins_hint_readonly": "OfflineGPT服务器对插件为只读模式。",
  "app.reload_later": "稍后",
  "app.reload_now": "立即重新加载",
  "app.reload_stop_tasks": "重新加载并停止任务",
  "app.skills_hint_readonly": "OfflineGPT服务器对skills为只读模式。请在高级设置中添加主机令牌以启用安装。",
  ...
  "blueprint.welcome_message": "你好，欢迎使用OfflineGPT！\n\n大家用OfflineGPT在电脑上编写CSV文件、自动化浏览器任务，以及将联系人同步到Notion。\n\n但唯一的限制是你的想象力。\n\n你想做什么？",
  "blueprint.welcome_title": "欢迎使用OfflineGPT",
  "common.add": "添加",
  "common.cancel": "取消",
  "common.close": "关闭",
  ...
  "config.reload_availability_hint": "仅本地工作区或已连接的OfflineGPT服务器支持重新加载。",
  ...
  "config.server_needed_hint": "需要连接OfflineGPT服务器以同步skills、插件和命令。",
  "config.server_section_desc": "连接OfflineGPT服务器。使用URL加服务器管理员提供的协作者或所有者令牌。",
  "config.server_section_title": "OfflineGPT服务器",
  "config.server_sharing_desc": "将这些详情分享给受信任的设备。保持服务器在同一网络以获得最快设置。",
  "config.server_sharing_menu_hint": "如需每个工作区的分享链接，请使用工作区菜单中的分享…",
  "config.server_sharing_title": "OfflineGPT服务器共享",
  "config.server_url_hint": "使用OfflineGPT服务器提供的URL。本地桌面工作区使用48000-51000范围内的持久高端口。",
  "config.server_url_input_label": "OfflineGPT服务器URL",
  "config.server_url_label": "OfflineGPT服务器URL",
  ...
  "context_panel.authorized_folders_no_access": "连接可写的OfflineGPT服务器工作区以编辑已授权文件夹。",
  "context_panel.browse_button": "浏览",
  "context_panel.config_access_unavailable": "此工作区无法访问OfflineGPT服务器配置。",
  "context_panel.config_read_only": "OfflineGPT服务器对工作区配置为只读连接。",
  ...
  "dashboard.create_remote_custom_subtitle": "连接自托管的OfflineGPT工作区。",
  "dashboard.create_remote_custom_title": "连接自定义远程",
  "dashboard.create_remote_workspace_confirm": "添加工作区",
  "dashboard.create_remote_workspace_subtitle": "保存OfflineGPT服务器为工作区。",
  ...
  "dashboard.edit_remote_workspace_subtitle": "更新此工作区的OfflineGPT服务器信息。",
  ...
  "dashboard.remote_server_details_hint": "连接自托管的OfflineGPT工作区。",
  ...
  "den.auto_reconnect_hint": "在浏览器中完成认证后，OfflineGPT将自动重新连接。",
  ...
  "den.cloud_provider_needs_server": "需要OfflineGPT服务器",
  ...
  "den.cloud_sleep_hint": "登录OfflineGPT Cloud，即使电脑进入睡眠状态也能保持任务运行。",
  ...
  "den.error_no_token": "桌面登录已完成，但OfflineGPT Cloud未返回会话令牌。",
  "den.error_paste_valid_code": "请粘贴有效的OfflineGPT登录链接或一次性登录码。",
  "den.error_signin_failed": "完成OfflineGPT Cloud登录失败。",
  ...
  "den.signin_code_note": "支持offlinegpt://den-auth链接或一次性授权码。",
  "den.signin_link_hint": "如果浏览器未自动跳回OfflineGPT，请在此粘贴OfflineGPT Cloud的登录链接或一次性登录码。",
  "den.signin_link_label": "登录链接或一次性登录码",
  "den.signin_link_placeholder": "offlinegpt://den-auth?...或粘贴登录码",
  "den.signin_title": "登录OfflineGPT Cloud",
  "den.signing_in": "正在完成OfflineGPT Cloud登录…",
  "den.signing_out": "正在退出…",
  "den.status_base_url_updated": "已更新Cloud控制平面URL。请重新登录以继续。",
  "den.status_browser_signin": "请在浏览器中完成登录以连接OfflineGPT。",
  "den.status_browser_signup": "请在浏览器中完成账户创建以连接OfflineGPT。",
  "den.status_cloud_signed_in_as": "已作为{email}连接OfflineGPT Cloud。",
  "den.status_cloud_signin_done": "已连接OfflineGPT Cloud。",
  "den.status_loaded_orgs": "已加载{count}个组织。",
  "den.status_signed_in_as": "已登录为{email}。",
  "den.status_signed_out": "已退出登录并清除此设备上的OfflineGPT Cloud会话。",
  "den.sync": "同步",
  "den.sync_now": "立即同步",
  ...
  "mcp.apps_subtitle": "连接常用工具，让OfflineGPT代你使用。",
  "mcp.apps_title": "应用",
  ...
  "mcp.auth.reload_notice": "要使更改生效，OfflineGPT需要刷新worker服务。这可能会中断正在运行的会话。",
  "mcp.auth.reload_remote_confirm": "要使更改生效，OfflineGPT需要刷新worker服务。这可能会停止你正在运行的会话。是否继续？",
  ...
  "mcp.auth.step2_title": "授权OfflineGPT",
  ...
  "mcp.login_unavailable": "此应用不支持从OfflineGPT发起登录。",
  ...
  "session.share_local_host_not_ready": "本地OfflineGPT主机尚未就绪。",
  "session.share_missing_host_url": "缺少OfflineGPT主机URL。",
  "session.share_missing_token": "缺少OfflineGPT令牌。",
  ...
  "session.share_offlinegpt_workers_only": "分享服务链接仅适用于OfflineGPT工作区。",
  ...
  "settings.background_checks_desc": "OfflineGPT启动时始终检查。同时每天检查一次。",
  ...
  "settings.capabilities_title": "OfflineGPT服务器功能",
  ...
  "settings.custom_binary_hint": "用于将OfflineGPT指向本地的OpenCode构建",
  ...
  "settings.debug_offlinegpt_server_version": "OfflineGPT服务器：{version}",
  "settings.deeplink_hint": "接受 offlinegpt:// 或 offlinegpt-dev:// 链接。",
  ...
  "settings.docker_containers_desc": "强制移除OfflineGPT启动的Docker容器",
  "settings.docker_containers_title": "OfflineGPT Docker容器",
  "settings.docker_requires_desktop": "Docker清理需要桌面应用",
  "settings.done": "完成",
  "settings.enable_developer_mode": "启用开发者模式",
  "settings.enable_exa": "启用Exa网页搜索",
  "settings.enable_exa_desc": "在OfflineGPT启动OpenCode时生效。",
  ...
  "settings.environment.footer_hint": "OFFLINEGPT_ 和 OPENCODE_ 键名保留给应用/运行时使用。OpenCode 运行时设置请通过 shell 配置。",
  "settings.environment.override_hint": "OfflineGPT 启动前已经存在的环境变量，会优先于这里保存的值。",
  ...
  "settings.environment.apply_confirm_body": "OfflineGPT 会重启本机 agents，让它们使用最新环境变量。正在运行的本机任务可能会停止。",
  "settings.environment.apply_no_local_workspace": "OfflineGPT 尚未连接到本机工作区。",
  ...
  "settings.environment.apply_refresh_failed": "更改已生效，但 OfflineGPT 状态没有刷新。如果界面看起来过期，请重新打开应用。",
  ...
  "settings.environment.validation_reserved": "OFFLINEGPT_ 和 OPENCODE_ 名称由 OfflineGPT/OpenCode 管理。",
  ...
  "settings.feedback_title": "帮助塑造OfflineGPT",
  ...
  "settings.open_deeplink_desc": "粘贴OfflineGPT深度链接或共享URL以打开。",
  ...
  "settings.offlinegpt_config_sidecar_desc": "配置和审批sidecar。",
  "settings.offlinegpt_diagnostics_title": "OfflineGPT服务器诊断",
  "settings.offlinegpt_server_desc": "用于应用同步、工作者和远程连接的会话控制平面。",
  "settings.offlinegpt_server_label": "OfflineGPT服务器",
  ...
  "settings.quit_hint": "OfflineGPT在清理后立即退出，以便下次启动时从此模式的全新本地状态开始。",
  "settings.recent_events": "最近的事件",
  "settings.reconnect_failed": "重新连接失败。请检查服务器URL/令牌后重试。",
  "settings.reconnect_server": "正在重新连接…",
  "settings.reconnect_server_failed": "重新连接OfflineGPT服务器失败。",
  "settings.reconnected": "已重新连接OfflineGPT服务器。",
  ...
  "settings.reset_app_data_description": "更彻底的方式。清除OfflineGPT缓存和应用数据。",
  "settings.reset_app_data_title": "重置应用数据",
  "settings.reset_app_data_warning": "清除此设备上的OfflineGPT缓存和应用数据。",
  "settings.reset_button": "重置",
  "settings.reset_cancel": "取消",
  "settings.reset_config_defaults": "正在重置…",
  "settings.reset_confirm_button": "重置并重启",
  "settings.reset_confirmation_hint": "输入 {resetWord} 以确认。OfflineGPT将重启。",
  "settings.reset_confirmation_label": "确认",
  "settings.reset_confirmation_placeholder": "输入RESET",
  "settings.reset_onboarding": "重置入门",
  "settings.reset_onboarding_description": "清除OfflineGPT偏好设置并重启应用。",
  "settings.reset_onboarding_title": "重置入门",
  "settings.reset_onboarding_warning": "清除OfflineGPT本地偏好设置和工作区入门标记。",
  "settings.reset_offlinegpt_desc_dev": "在开发模式下，仅清除offlinegpt-dev-data中的隔离OpenCode开发状态。",
  "settings.reset_offlinegpt_desc_prod": "在开发模式下，仅清除offlinegpt-dev-data中的隔离OpenCode开发状态。",
  "settings.reset_offlinegpt_title": "重置OfflineGPT + OpenCode状态",
  ...
  "settings.restart_blocked_message": "OfflineGPT需要重启以完成此更新。为避免中断当前工作，安装已暂停，直到你的活动运行完成或你手动停止它们。",
  "settings.restart_failed": "重启失败。请检查日志后重试。",
  "settings.restart_opencode": "正在重启…",
  "settings.restart_offlinegpt_server": "正在重启…",
  ...
  "settings.runtime_desc": "本地引擎和OfflineGPT服务器的状态。",
  ...
  "settings.tab_description_appearance": "调整OfflineGPT在桌面、系统主题和应用外观方面的显示效果。",
  ...
  "settings.tab_description_general": "连接提供商、选择默认模型、授权文件夹，以及控制所选OfflineGPT工作区和运行时连接。",
  ...
  "settings.updates": "更新",
  "settings.updates_desc": "保持OfflineGPT为最新版本。",
  ...
  "skills.host_only_error": "Skills管理需要本地工作区或已连接的OfflineGPT服务器。",
  "skills.import": "导入",
  ...
  "skills.share_option_team_desc": "将此skill添加到当前OfflineGPT Cloud组织。",
  ...
  "skills.share_team_sign_in_hint": "浏览器将打开OfflineGPT Cloud。登录后返回此处。",
  ...
  "status.docs": "文档",
  "status.feedback": "反馈",
  "status.limited_hint": "重新连接以恢复完整OfflineGPT功能",
  ...
  "status.offlinegpt_ready": "OfflineGPT就绪",
  ...
  "system.reload_body_default": "OfflineGPT检测到需要重新加载OpenCode实例的变更。",
  "system.reload_body_mcp": "OpenCode在启动时加载MCP服务器。重新加载引擎以激活新连接。",
  "system.reload_body_mixed": "OfflineGPT检测到OpenCode配置变更。重新加载引擎以应用。",
  ...
  "workspace_list.remote_worker_unavailable_hint": "连接修复前，OfflineGPT 无法从这个远程工作区加载任务。",
