 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, OfflineGPT) NÃO são traduzidos
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "O servidor OfflineGPT está em modo somente leitura para plugins.",
  "app.reload_later": "Depois",
  "app.reload_now": "Recarregar agora",
  "app.reload_stop_tasks": "Recarregar e Parar Tarefas",
  "app.skills_hint_readonly": "O servidor OfflineGPT está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao OfflineGPT!\n\nAs pessoas usam o OfflineGPT para escrever arquivos .csv no computador, automatizar tarefas no navegador e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao OfflineGPT",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores OfflineGPT conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor OfflineGPT necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor OfflineGPT. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor OfflineGPT",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor OfflineGPT. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor OfflineGPT",
  "config.server_url_label": "URL do Servidor OfflineGPT",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace OfflineGPT com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor OfflineGPT não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor OfflineGPT está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor OfflineGPT desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace OfflineGPT com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker OfflineGPT auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker OfflineGPT auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor OfflineGPT como workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor OfflineGPT para este workspace.",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker OfflineGPT auto-hospedado.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o OfflineGPT reconectará aqui automaticamente.",
  ...
  "den.cloud_provider_needs_server": "Requer o servidor OfflineGPT",
  ...
  "den.cloud_sleep_hint": "Entre no OfflineGPT Cloud para manter suas tarefas ativas mesmo quando seu computador entrar em suspensão.",
  ...
  "den.error_no_token": "Login no desktop concluído, mas o OfflineGPT Cloud não retornou um token de sessão.",
  "den.error_paste_valid_code": "Cole um link de login do OfflineGPT válido ou um código de uso único.",
  "den.error_signin_failed": "Falha ao concluir o login no OfflineGPT Cloud.",
  ...
  "den.signin_code_note": "Aceita um link offlinegpt://den-auth ou o código de uso único.",
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o OfflineGPT automaticamente, cole o link de login ou código de uso único do OfflineGPT Cloud aqui.",
  "den.signin_link_label": "Link de login ou código de uso único",
  "den.signin_link_placeholder": "offlinegpt://den-auth?... ou código colado",
  "den.signin_title": "Entrar no OfflineGPT Cloud",
  "den.signing_in": "Concluindo login no OfflineGPT Cloud...",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o OfflineGPT.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o OfflineGPT.",
  "den.status_cloud_signed_in_as": "OfflineGPT Cloud conectado como {email}.",
  ...
  "den.status_signed_out": "Saiu do OfflineGPT Cloud e a sessão foi limpa neste dispositivo.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o OfflineGPT as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o OfflineGPT precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o OfflineGPT precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o OfflineGPT",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo OfflineGPT.",
  ...
  "session.share_local_host_not_ready": "O host local do OfflineGPT ainda não está pronto.",
  "session.share_missing_host_url": "URL do host OfflineGPT ausente.",
  "session.share_missing_token": "Token do OfflineGPT ausente.",
  ...
  "session.share_offlinegpt_workers_only": "Links de compartilhamento estão disponíveis para workers OfflineGPT.",
  ...
  "settings.background_checks_desc": "O OfflineGPT sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor OfflineGPT",
  ...
  "settings.custom_binary_hint": "Use para apontar o OfflineGPT para um build local do OpenCode",
  ...
  "settings.deeplink_hint": "Aceita links offlinegpt:// ou offlinegpt-dev://.",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo OfflineGPT",
  "settings.docker_containers_title": "Containers Docker do OfflineGPT",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o OfflineGPT inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o OfflineGPT",
  ...
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do OfflineGPT para abrir.",
  ...
  "settings.offlinegpt_config_sidecar_desc": "Sidecar de configuração e aprovações.",
  "settings.offlinegpt_diagnostics_title": "Diagnósticos do servidor OfflineGPT",
  "settings.offlinegpt_server_desc": "Plano de controle de sessão para sincronização do app, workers e acesso remoto.",
  ...
  "settings.quit_hint": "O OfflineGPT fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor OfflineGPT.",
  "settings.reconnected": "Reconectado ao servidor OfflineGPT.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do OfflineGPT.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do OfflineGPT neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O OfflineGPT será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do OfflineGPT e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no OfflineGPT.",
  "settings.reset_offlinegpt_desc_dev": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de offlinegpt-dev-data.",
  "settings.reset_offlinegpt_desc_prod": "Com o modo dev ativo, limpa apenas o estado isolado do OpenCode dev dentro de offlinegpt-dev-data.",
  "settings.reset_offlinegpt_title": "Redefinir estado do OfflineGPT + OpenCode",
  ...
  "settings.restart_blocked_message": "O OfflineGPT precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor OfflineGPT.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do OfflineGPT no desktop, tema do sistema e decoração do app.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace OfflineGPT selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o OfflineGPT atualizado.",
  ...
  "share_skill_destination.connect_remote_hint": "Vincule um host OfflineGPT e selecione-o na lista para importar esta skill.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor OfflineGPT conectado.",
  ...
  "skills.share_option_team_desc": "Adicione esta skill à organização ativa do OfflineGPT Cloud.",
  ...
  "skills.share_team_sign_in_hint": "O OfflineGPT Cloud abre no navegador. Volte aqui após entrar.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do OfflineGPT",
  ...
  "status.offlinegpt_ready": "OfflineGPT Pronto",
  ...
  "system.reload_body_default": "O OfflineGPT detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O OfflineGPT detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "O OfflineGPT não consegue carregar tarefas deste worker até que a conexão seja corrigida.",
