...
const SUPPORT_EMAIL = "team@offlinegptlabs.com";
const SUPPORT_MAILTO = `mailto:${SUPPORT_EMAIL}?subject=OfflineGPT%20Den%20remote%20worker%20upgrade`;

/**
 * Small inline link rendered inside the remote-worker error card. When clicked,
 * it opens a dialog explaining the OfflineGPT Den upgrade situation and how to
 * reach support.
 */
export function OfflineGPTDenHelpLink() {
  ...
  return (
    <>
      ...
      >
        Using OfflineGPT Den Remote Workers? Click here
      </button>

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>OfflineGPT Den remote workers</DialogTitle>
            <DialogDescription>
              We recently upgraded our servers. If your remote worker was
              provisioned before that upgrade, it may no longer be compatible
              with the current OfflineGPT app.
            </DialogDescription>
          </DialogHeader>
