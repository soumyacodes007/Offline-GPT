...
export const PERSISTED_UI_STATE_KEY = "offlinegpt:ui-state:v1";
const SIDEBAR_COOKIE_NAME = "sidebar_state";
const LEGACY_WORKSPACE_LEFT_SIDEBAR_WIDTH_KEY = "offlinegpt.workspace-shell.left-width.v1";
const LEGACY_WORKSPACE_RIGHT_SIDEBAR_EXPANDED_KEY = "offlinegpt.workspace-shell.right-expanded.v3";
const LEGACY_WORKSPACE_RIGHT_SIDEBAR_WIDTH_KEY = "offlinegpt.workspace-shell.right-width.v1";
...
function syncApplicationMenuVisible(visible: boolean): void {
  void globalThis.window?.__OFFLINEGPT_ELECTRON__?.invokeDesktop?.("__setApplicationMenuVisible", visible);
}
