...
const ACTIVE_WORKSPACE_KEY = "offlinegpt.react.activeWorkspace";
const SESSION_BY_WORKSPACE_KEY = "offlinegpt.react.sessionByWorkspace";
const WORKSPACE_ORDER_KEY = "offlinegpt.react.workspaceOrder";
const WORKSPACE_PROJECT_DIMENSION_KEY = "offlinegpt.react.workspaceProjectDimension";
