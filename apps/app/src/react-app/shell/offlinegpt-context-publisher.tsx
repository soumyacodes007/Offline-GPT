...
import { usePublishOfflineGptContext } from "./control/control-provider";
import { buildOfflineGptContext } from "./offlinegpt-context-projector";
import { useUiStateStore } from "./ui-state-store";

export function OfflineGptContextPublisher() {
  ...
  const context = useMemo(() => buildOfflineGptContext({
    route,
    revision,
  ...
  usePublishOfflineGptContext(context);
  return null;
}
