...
const HELPER_APP = process.env.OFFLINEGPT_COMPUTER_USE_HELPER
  ?? join(repoRoot, "apps/desktop/resources/helpers/OfflineGPT Computer Use.app");
...
try { execSync(`pkill -f 'OfflineGPT Computer Use.app'`); } catch {}
