...
export const roadmapSections: RoadmapSection[] = [
  {
    ...
    description:
      "The desktop app is the main OfflineGPT experience. It is where people work with files, run agents, manage sessions, create skills, connect services, and customize a workspace.",
    callout:
      "The desktop app is where most people configure OfflineGPT today. Connect is how that configuration travels.",
    items: [
      {
  ...
  },
  {
    ...
    description:
      "What you configure in OfflineGPT should not stay trapped in one interface. OfflineGPT Connect brings the same capabilities into the agents you already use.",
    items: [
      {
        title: "OfflineGPT Connect MCP",
      ...
      },
      {
        ...
        description: "Use OfflineGPT from compatible agents without rewriting skills or changing MCP servers.",
        status: "live",
      },
      {
  ...
  },
  {
    ...
    description:
      "OfflineGPT Cloud is the control plane for distributing capabilities, applying desktop policies, managing identity and access, and understanding adoption across the organization.",
    callout:
      "Configure policies and access once in OfflineGPT Cloud. The desktop app and OfflineGPT Connect apply them for each member and team.",
    items: [
      {
      ...
      },
      {
        ...
        description: "Import Claude-compatible plugin and marketplace manifests and normalize their skills, MCPs, commands, and tools into OfflineGPT extensions.",
        status: "live",
      },
      {
        title: "SAML SSO",
      ...
      },
      {
        ...
        description: "Extend OTLP traces, metrics, and logs across OfflineGPT services and deployment paths.",
        status: "building",
      },
    ],
  },
  ...
  },
  {
    ...
    title: "OfflineGPT on every surface",
    description:
      "The desktop app remains the richest OfflineGPT experience. Other surfaces provide focused ways to reach the same capabilities, permissions, workspaces, and history.",
    items: [
      {
        title: "OfflineGPT desktop",
        description: "The complete interface for creating, configuring, and doing work.",
        status: "live",
      },
      {
        title: "Existing AI agents through MCP",
        description: "Bring OfflineGPT into the coding and agent tools you already use.",
        status: "live",
      },
      {
        title: "Slack",
      ...
      },
      {
        ...
        description: "Reach OfflineGPT from more of the places where requests and decisions arrive.",
        status: "exploring",
      },
      {
        title: "Custom organization agents",
        description: "Build specialized surfaces on top of the same OfflineGPT workspace and capability system.",
        status: "exploring",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Keep agent context small while making the full OfflineGPT capability catalog available on demand.",
        status: "live",
      },
      {
...
export function OfflineGPTRoadmap({
  feedbackHref = "https://offlinegptlabs.com/feedback?source=roadmap",
  docsHref = "https://offlinegptlabs.com/docs",
}: {
  feedbackHref?: string
  docsHref?: string
}) {
  ...
  return (
    <div data-testid="offlinegpt-roadmap" className="text-[#011627]">
      <section className="pb-14 pt-10 md:pb-20 md:pt-16">
        ...
        <div className="mt-8 grid gap-6 text-base leading-7 text-slate-600 md:grid-cols-2 md:text-lg md:leading-8">
          <p>
            Most people use OfflineGPT through the desktop app today. It is where you create a workspace, work with files, connect services, add skills, and customize how your agent works.
          </p>
          <p>
            What you create there should not stay trapped there. OfflineGPT Connect already brings the same capabilities into compatible agents. Next come persistent hosted workspaces, Slack, mobile, and more.
          </p>
        </div>
      ...
      <section className="py-16 text-center md:py-24">
        <div className="mx-auto max-w-2xl">
          ...
          <h2 className="mt-4 text-3xl font-medium tracking-[-0.035em] sm:text-4xl md:text-5xl">what should OfflineGPT build next?</h2>
