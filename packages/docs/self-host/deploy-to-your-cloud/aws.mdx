---
title: "Deploy on AWS"
description: "Run OfflineGPT on Amazon EKS with Amazon RDS for MySQL."
---
...
The OfflineGPT chart manages Deployments, Services, ConfigMaps, Secret references, probes, and the database migration Job.
...
For exact CLI commands, values, DNS/TLS choices, migration troubleshooting, verification, and cleanup, follow the [AWS EKS operator runbook](https://github.com/soumyacodes007/offline-gpt/blob/dev/docs/aws-eks-helm.md).
