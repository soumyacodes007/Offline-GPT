...
description: "Run OfflineGPT on Azure Kubernetes Service with Azure Database for MySQL."
---
...
The OfflineGPT chart manages Deployments, Services, ConfigMaps, Secret references, probes, the Ingress, and the database migration Job.
...
For exact Azure CLI commands, values, TLS options, migration troubleshooting, verification, and cleanup, follow the [Azure AKS operator runbook](https://github.com/soumyacodes007/offline-gpt/blob/dev/docs/azure-aks-helm.md).
