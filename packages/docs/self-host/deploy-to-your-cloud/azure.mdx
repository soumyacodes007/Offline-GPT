...
For exact Azure CLI commands, values, TLS options, migration troubleshooting, verification, and cleanup, follow the [Azure AKS operator runbook](https://github.com/different-ai/offlinegpt/blob/dev/docs/azure-aks-helm.md).
