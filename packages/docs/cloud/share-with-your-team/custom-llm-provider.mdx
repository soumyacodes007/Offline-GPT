...
description: "Create a custom provider definition in OfflineGPT Cloud and import it into the desktop app"
---
...
<Frame>
  ![Custom LLM provider detail in OfflineGPT Cloud](/images/cloud-custom-llm-provider-detail.png)
</Frame>
...
```json
{
  ...
  "doc": "https://infron.ai/docs/frameworks-and-integrations/offlinegpt",
...
<Frame>
  ![DeepSeek V3.2 via Infron in the OfflineGPT Chat model picker](/images/infron-model-picker.png)
</Frame>

Pick the model and it's live in the session footer:

<Frame>
  ![Infron · DeepSeek V3.2 selected in an OfflineGPT session](/images/infron-model-active.png)
</Frame>
