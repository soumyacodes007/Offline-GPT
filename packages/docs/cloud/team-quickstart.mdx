...
description: "Create an OfflineGPT Cloud organization, invite teammates, publish a skill plugin through a Collection, and use it from the desktop app"
---

Set up a team on [app.offlinegptlabs.com](https://app.offlinegptlabs.com), publish your first skill, and trigger it from the desktop app — in about 15 minutes.

By the end of this walkthrough you will have:

1. Created an organization on OfflineGPT Cloud.
...
5. Signed in to the org from the OfflineGPT desktop app and triggered the skill with a plain-language prompt.

<Note>
**Seats:** every workspace includes **5 free seats**. If you need more seats, SSO, or early access to analytics, [reach out](mailto:founders@offlinegptlabs.com).
</Note>
...
Head to [app.offlinegptlabs.com](https://app.offlinegptlabs.com). Enter your work email and press **Next** — OfflineGPT routes you to the right sign-in step automatically.

<Frame>
  ![Start using OfflineGPT — email step](/images/cloud-team-quickstart/01-signin-email.png)
</Frame>
...
Right after sign-up, OfflineGPT asks you to **name your team**. This creates your organization — you can rename it later, and no credit card is required.
...
Now switch to the [OfflineGPT desktop app](https://offlinegptlabs.com). On the welcome screen, click **Joining a team? Sign in** and sign in with the same account.
...
<Note>
**Need more?** The first 5 users in your organization are free; additional users are $10 per user per month. For SSO or early analytics access, [contact us](mailto:founders@offlinegptlabs.com).
</Note>
