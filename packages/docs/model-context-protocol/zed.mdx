---
title: "OfflineGPT MCP for Zed"
sidebarTitle: "Zed"
description: "Zed MCP setup for OfflineGPT Connect through mcp-remote and OAuth access to your org's shared capabilities."
---

The OfflineGPT MCP server ([OfflineGPT Connect](/cloud/run-in-the-cloud/cloud-mcp))
enables Zed to use the OfflineGPT capabilities your organization has made
