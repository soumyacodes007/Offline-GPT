---
title: "Stewardship"
description: "The promises behind OfflineGPT's open-core split: what stays open, what can move between tiers, and how the MIT conversion works."
---

OfflineGPT is an open-core product: the desktop app and core platform are MIT,
and the `ee/` directory (OfflineGPT Den, the org control plane) is
...
The OfflineGPT name, logo, and product names are trademarks of Different AI,
...
- **Allowed without permission:** factually identifying that you use or built
  on OfflineGPT ("powered by OfflineGPT", "built with OfflineGPT"), unmodified use
  of the app with its own branding, and nominative references in
  documentation, reviews, and talks.
- **Requires an Enterprise plan (internal white-labeling):** replacing OfflineGPT
...
[sales@offlinegptlabs.com](mailto:sales@offlinegptlabs.com).
