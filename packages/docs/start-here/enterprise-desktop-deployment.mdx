...
OfflineGPT ships a dedicated enterprise distribution alongside the public one. Both are published on [GitHub Releases](https://github.com/soumyacodes007/offline-gpt/releases); enterprise artifacts follow the `enterprise` update channel.
