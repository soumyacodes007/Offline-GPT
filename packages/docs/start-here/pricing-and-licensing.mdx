...
description: "OfflineGPT's public pricing — Free, Team, and Enterprise — and how the MIT + OfflineGPT EE License split works."
---

Our pricing is public, like the rest of our handbook. The same prices apply
whether you use OfflineGPT Cloud or self-host. There are no deployment fees, and
...
| **Users** | Up to 5 | Up to 100 | Unlimited (volume pricing above 100 — [talk to sales](mailto:sales@offlinegptlabs.com)) |
...
[subscription terms](https://offlinegptlabs.com/terms/subscription) and
...
The [repository](https://github.com/soumyacodes007/offline-gpt) uses a
...
- **Everything under `ee/` (OfflineGPT Den, the org control plane) is
  source-available under the
  [OfflineGPT EE License](https://github.com/soumyacodes007/offline-gpt/blob/dev/ee/LICENSE).**
...
[subscription terms](https://offlinegptlabs.com/terms/subscription). Every
...
[ask us](mailto:sales@offlinegptlabs.com). If you want a supported pilot
instead (a dedicated engineering contact, deployment guidance, and response
targets), [talk to sales](mailto:sales@offlinegptlabs.com).
