...
description: "Understand when OfflineGPT model usage starts and how to control it."
---

OfflineGPT uses model tokens when a member actually runs work. Setup actions do not consume tokens by themselves.
