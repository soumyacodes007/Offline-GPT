...
const LOGO_URL = "https://offlinegptlabs.com/email/offlinegpt-mark.png"
...
export function OrganizationInviteEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>{invitedByName} invited you to join {organizationName} on OfflineGPT</Preview>
      <Body style={styles.body}>
        <Container style={styles.frame}>
          <Section style={styles.brand}>
            <Img src={LOGO_URL} width="31" height="24" alt="OfflineGPT" style={styles.brandLogo} />
            <span style={styles.brandName}>OfflineGPT</span>
          </Section>
          <Section style={styles.card}>
            <Text style={styles.eyebrow}>Invitation</Text>
            <Heading style={styles.heading}>Join {organizationName} on OfflineGPT</Heading>
          ...
          <Text style={styles.footer}>
            You received this email because someone invited you to an OfflineGPT workspace.
            <br />
            OfflineGPT · offlinegptlabs.com
          </Text>
        </Container>
      </Body>
    </Html>
