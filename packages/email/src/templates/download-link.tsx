...
export function DownloadLinkEmail({ organizationName, downloadUrl }: DownloadLinkEmailProps) {
  const intro = organizationName
    ? `Here's your link to download the OfflineGPT desktop app for ${organizationName}.`
    : "Here's your link to download the OfflineGPT desktop app."

  return (
    <Html>
      <Head />
      <Preview>Your OfflineGPT download link</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.eyebrow}>OfflineGPT desktop</Text>
          <Heading style={styles.heading}>Download OfflineGPT</Heading>
          ...
          <Button href={downloadUrl} style={styles.button}>Download OfflineGPT</Button>
